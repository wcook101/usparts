      ...
      <div className="lg:hidden">
        ...
        {open ? (
          <>
            ...
            <div
              id={panelId}
              className="fixed inset-x-0 top-[5rem] z-50 max-h-[calc(100dvh-5rem)] overflow-y-auto border-b border-slate-200 bg-white shadow-lg sm:top-[6.5rem] sm:max-h-[calc(100dvh-6.5rem)]"
            >
